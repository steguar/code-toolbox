...
The following options are available:
    ...
    -i [INDEX]     Index for file identification.
...
void parse_options(int argc , char *argv[], embeddingSD_t &the_graph)
{
  ...
  // Parsing options.
  int opt;
  while ((opt = getopt(argc,argv,"ab:cfkpo:r:qs:vd:e:i:")) != -1)
  {
    switch(opt)
    {
      case 'a':
    ...
    // Custom index handling by Davide Torre (CNR - IAC) 2025-07-31
      case 'i':
        the_graph.HAS_INDEX = true;        
        the_graph.INDEX = optarg;
        break;
