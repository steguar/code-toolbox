...
# ============================================================================
# Programmatic interface (added for Streamlit direct execution)
# ============================================================================
...
def run_rhbm_randomize(
    *,
    ...
    """
    Direct-call interface equivalent to CLI execution.

    This function mirrors the logic in the __main__ block but allows
    importing and running without subprocess or argparse.
    """
    ...
    # The original script should already import and use `randomize`
    # with the same signature as in the CLI section.
    randomize(
        input_graph,
        communities,
        assortativity,
    ...
    logger.info(f"Randomization completed in {time.time() - start_time:.2f} seconds.")
